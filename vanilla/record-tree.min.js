...
{\r
    ...
    d="m 1237.4389,207.63366 -1.8991,1.8987 a 0.65841136,0.65841136 90.003442 0 0 0,0.93116 l 0.4831,0.48317 a 14628.329,14628.329 44.999244 0 0 0.9312,0.93118 l 3.7936,3.79311 a 0.65840885,0.65840885 89.998393 0 1 0,0.93116 l -3.7936,3.7936 a 8783.6896,8783.6896 135.00442 0 1 -0.9313,0.93111 l -0.4829,0.48283 a 0.65811,0.65811 89.993977 0 0 10e-5,0.93094 l 1.8987,1.89741 a 0.65867085,0.65867085 179.98891 0 0 0.9314,-1.8e-4 l 0.4826,-0.48267 a 45427.77,45427.77 134.99941 0 1 0.9312,-0.93119 l 3.7931,-3.79308 a 0.65848899,0.65848899 179.99848 0 1 0.9312,-2e-5 l 3.7936,3.79312 a 10110.91,10110.91 44.992994 0 0 0.9313,0.93108 l 0.483,0.48285 a 0.65856615,0.65856615 179.99438 0 0 0.9313,-9e-5 l 1.897,-1.89705 a 0.65833101,0.65833101 89.994378 0 0 -10e-5,-0.93111 l -0.483,-0.48285 a 5293.5057,5293.5057 44.99639 0 1 -0.9313,-0.93113 l -3.793,-3.79354 a 0.65849247,0.65849247 90.001607 0 1 0,-0.93122 l 3.793,-3.79305 a 149190.44,149190.44 134.99995 0 1 0.9312,-0.93119 l 0.4832,-0.48321 a 0.65863247,0.65863247 90.008202 0 0 10e-5,-0.93132 l -1.8972,-1.89834 a 0.65838576,0.65838576 0.01346964 0 0 -0.9312,-2.2e-4 l -0.483,0.48285 a 7148.543,7148.543 135.00546 0 0 -0.9313,0.9311 l -3.7936,3.79359 a 0.65841791,0.65841791 0.00151591 0 1 -0.9312,-3e-5 l -3.7931,-3.79353 a 52707.551,52707.551 45.002134 0 0 -0.9312,-0.93122 l -0.4826,-0.48267 a 0.65849044,0.65849044 0.00323988 0 0 -0.9312,-5e-5 z"
    transform="translate(-1232.6358,-204.72848)" />
</svg>`,y="record-tree",h=class extends HTMLElement{static observedAttributes=[];#t;path=[];#n=new Set;#r=new Array;#a=new Array;#e=new Array;#s=new Array;#i=new Array;#o=0;constructor(){super(),this.getRootNode().adoptedStyleSheets.push(E),this.addEventListener("click",this.#l.bind(this))}#l(t){let e=t.target.closest("svg")!=null?t.target.closest("button"):t.target;if(e==null||!e.classList.contains("remove"))return;let a=e.parentElement?.classList.contains("property")?e.parentElement:e.parentElement?.parentElement?.classList.contains("collection")?e.parentElement.parentElement:null;if(a==null){console.error("Unknown button clicked");return}if(t.stopPropagation(),t.preventDefault(),this.hasAttribute("removed-class")){let r=this.getAttribute("removed-class");(r==null||r=="")&&(r=f),a.classList.contains(r)?(a.classList.remove(r),a.dataset.path!=".properties"&&this.#n.delete(a.dataset.path),e.innerHTML=m,e.title="Remove",this.dispatchEvent(new CustomEvent("restore",{detail:{path:a.dataset.path}}))):(a.classList.add(r),a.dataset.path!=".properties"&&this.#n.add(a.dataset.path),e.innerHTML=b,e.title="Undo",e.classList.add("undo"),this.dispatchEvent(new CustomEvent("remove",{detail:{path:a.dataset.path}})))}else a.remove(),this.#n.add(a.dataset.path),this.dispatchEvent(new CustomEvent("remove",{detail:{path:a.dataset.path}}))}getPathArray(){return this.path}getCurrentPathString(){return this.path.join(".")}getInitialData(){return this.#t}setData(t){this.#t=t,this.renderRecordData(this.#t)}async renderRecordData(t){this.innerHTML="",this.path=[],await this.renderData(t,this),this.path=[],this.style.setProperty("--property-name-width",`${this.#o}px`)}async renderData(t,e,a=!0){let r=this.path[this.path.length-1]??this.getAttribute("parent-name")??"Data";if(Array.isArray(t)){let s=this.renderArrayAsCollection;for(let n=0;n<this.#r.length;n++)if(this.#r[n].condition(r,t,e)==!0){s=this.#r[n].renderer;break}await s.call(this,r,t,e)}else if(Object.prototype.toString.call(t)==="[object Object]"){t=this.draftObject(t);let s=this.renderObjectAsCollection;for(let n=0;n<this.#a.length;n++)if(this.#a[n].condition(r,t,e)==!0){s=this.#a[n].renderer;break}await s.call(this,r,t,e)}else if(a==!0){let s=this.path.filter((l,p)=>p<this.path.length-1),n=this.querySelector(`details[data-path="${s.join(".")}.properties"]`),i=n==null?null:n.querySelector("ul");n==null&&(n=this.createCollectionDetailsElement("Properties",`${s.join(".")}.properties`,["collection","properties"],!1),n.toggleAttribute("open",!0),i=document.createElement("ul"),n.append(i),e.append(n)),i.children.length>10&&n.toggleAttribute("open",!1);let o=this.renderObjectProperty;for(let l=0;l<this.#e.length;l++)if(this.#e[l].condition(r,t,i)==!0){o=this.#e[l].renderer;break}await o.call(this,r,t,i)}else{let s=this.renderObjectProperty;for(let n=0;n<this.#e.length;n++)if(this.#e[n].condition(r,t,e)==!0){s=this.#e[n].renderer;break}await s.call(this,r,t,e)}}addCustomCollectionRenderer(t,e){this.#r.push({condition:t,renderer:e})}addCustomObjectRenderer(t,e){this.#a.push({condition:t,renderer:e})}addCustomPropertyRenderer(t,e){this.#e.push({condition:t,renderer:e})}addCustomPropertyNameGenerator(t,e){this.#s.push({condition:t,generator:e})}addCustomPropertyValueGenerator(t,e){this.#i.push({condition:t,generator:e})}clear(){this.innerHTML=""}refresh(){this.setData(this.#t)}getUpdatedData(){let t=structuredClone(this.#t);for(let[e]of this.#n.entries()){let a=e.split("."),r=t,s=t[a[0]],n=a[0];for(let i=1;i<a.length;i++)n=a[i],r=s,s=r[n];r!=null&&s!=null&&delete r[n]}return t}createCollectionDetailsElement(t,e,a,r){let s=document.createElement("details");a!=null&&s.classList.add(...a),s.setAttribute("data-path",e);let n=document.createElement("summary"),i=document.createElement("span");if(i.textContent=t,i.classList.add("name"),n.append(i),r!=!1){let o=document.createElement("button");o.innerHTML=m,o.title="Remove",o.classList.add("remove"),n.append(o)}return s.append(n),s}async renderArrayAsCollection(t,e,a){let r=isNaN(parseInt(t))?t:`[${t}]`,s=this.createCollectionDetailsElement(r,this.path.join("."),["collection"]);this.path.length==0&&s.setAttribute("open",""),a.append(s);for(let n=0;n<e.length;n++)this.path.push(n.toString()),await this.renderData(e[n],s,!1),this.path.pop()}async renderObjectAsCollection(t,e,a){let r=isNaN(parseInt(t))?t:e.name!=null&&e.name.trim()!=""?e.name:e.description!=null&&e.description.trim()!=""?e.description:e.key!=null&&e.key.trim()!=""?e.key:e.id!=null&&e.id.toString().trim()!=""?e.id:`[${t}]`,s=this.createCollectionDetailsElement(r,this.path.join("."),["collection"]);this.path.length==0&&s.setAttribute("open",""),a.append(s);for(let[n,i]of Object.entries(e))this.path.push(n),await this.renderData(e[n],s),this.path.pop()}async renderObjectProperty(t,e,a){let r=a instanceof HTMLUListElement?"li":"div",s=document.createElement(r);s.classList.add("property"),s.dataset.path=this.path.join(".");let n=this.createPropertyName;for(let c=0;c<this.#s.length;c++)if(this.#s[c].condition(t,e,a)==!0){n=this.#s[c].generator;break}let i=await n(t,e,a),o=document.createElement("span");o.classList.add("delimiter"),o.textContent=":";let l=this.createPropertyValue.bind(this);for(let c=0;c<this.#i.length;c++)if(this.#i[c].condition(t,e,a)==!0){l=this.#i[c].generator;break}let p=await l(t,e,a),d=document.createElement("button");d.innerHTML=m,d.title="Remove",d.classList.add("remove"),s.append(i,o,p,d),s.title=`${i.getAttribute("title")}: ${p.getAttribute("title")}`,a.append(s);let u=Math.ceil(i.getBoundingClientRect().width);this.#o<u&&(this.#o=u)}createPropertyName(t,e,a){let r=document.createElement("span");return r.classList.add("name"),r.textContent=t,r.title=t,r}createPropertyValue(t,e,a){let r=document.createElement("span");return r.classList.add("value"),e===void 0?e=this.getAttribute("undefined-value")??"[ undefined ]":e===null?e=this.getAttribute("null-value")??"[ null ]":e=e.toString(),e.trim()==""&&(e=this.getAttribute("blank-value")??"[ blank text ]"),r.textContent=e.length>1024?e.substring(0,1024):e,r.title=e.startsWith("data:")?"[ Binary Data ]":e,r}async renderCollectionAsKeyValuePairs(t,e,a){let r=this.createCollectionDetailsElement(t,this.path.join("."),["collection","key-value-pairs"]),s=document.createElement("ul");r.append(s);for(let n=0;n<e.length;n++)this.path.push(e[n].key),await this.renderObjectProperty(e[n].key,e[n].value,s),this.path.pop();a.append(r)}async renderCollectionAsValues(t,e,a){let r=this.createCollectionDetailsElement(t,this.path.join("."),["collection","values"]),s=document.createElement("ul");r.append(s);for(let n=0;n<e.length;n++)this.path.push(e[n]),await this.renderObjectAsValue(e[n],e[n],s),this.path.pop();a.append(r)}async renderObjectAsValue(t,e,a){let r=document.createElement("li");r.classList.add("property"),r.dataset.path=this.path.join(".");let s=document.createElement("span");s.classList.add("value"),s.textContent=e.toString(),s.title="[ Object ]";let n=document.createElement("button");n.innerHTML=m,n.title="Remove",n.classList.add("remove"),r.append(s,n),a.append(r)}renderDataObject(t,e){if(Array.isArray(t))for(let a=0;a<t.length;a++){let r=t[a],s=document.createElement("details"),n=document.createElement("summary"),i=r.name??r.description??r.key;(i==null||i.trim()=="")&&(i=a.toString()),n.classList.add("property"),n.textContent=i.substring(0,Math.min(i.length,20)),s.classList.add("subrecord"),e.appendChild(s),s.appendChild(n),this.renderDataObject(r,s)}else{let a=null;for(let[r,s]of Object.entries(t))if(Array.isArray(s)||Object.prototype.toString.call(s)==="[object Object]"){let n=document.createElement("details"),i=document.createElement("summary");i.classList.add("property"),i.textContent=r,n.classList.add("subrecord"),e.appendChild(n),n.appendChild(i),this.renderDataObject(s,n)}else{a==null&&(a=e.querySelector(":scope > ul"),a==null&&(a=document.createElement("ul"),e.appendChild(a)));let n=document.createElement("li");n.classList.add("property");let i=document.createElement("span");i.classList.add("name"),i.textContent=r;let o=document.createElement("span");o.classList.add("value");let l=s.toString();o.textContent=l.substring(0,Math.min(l.length,20)),n.append(i,o),a.append(n)}}}draftObject(t){return Object.assign({},t,this.extractProperties(t))}extractProperties(t){let e=this.getPropertyNames(t),a={};for(let r=0;r<e.length;r++)a[e[r]]=t[e[r]];return a}getPropertyNames(t){let e=Reflect.getPrototypeOf(t),a=Object.getOwnPropertyDescriptors(e);return Object.entries(a).filter(r=>typeof r[1].get=="function"&&r[0]!=="__proto__").map(r=>r[0])}};customElements.get(y)==null&&customElements.define(y,h);export{h as RecordTreeElement};
